...
import {
  ...
  TRANSACTION_PAYMENT_CARD_OPTIONS,
...
const transactionSchema = z.object({
  ...
  paymentCard: z.nativeEnum(TransactionCard).nullable().optional(),
});
  ...
  async function onSubmit(data: TransactionSchema) {
    try {
      if (
        ...
        data.paymentMethod != TransactionPaymentMethod.DEBIT_CARD
      )
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="Selecione o cartão usado" />
                        </SelectTrigger>
                        <SelectContent>
                          {TRANSACTION_PAYMENT_CARD_OPTIONS.map((option) => (
                            <SelectItem key={option.value} value={option.value}>
                              {option.label}
                            </SelectItem>
                          ))}
